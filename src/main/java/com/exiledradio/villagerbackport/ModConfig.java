...
public final class ModConfig {
    ...
    public static final class Villages {
        ...
        @Config.Comment({
                ...
                "Recurrent Complex uses for RLCraft's own village houses. Vanilla houses, RLCraft",
    ...
    public static final class Structures {
        ...
        @Config.Comment({
                ...
                "structures, and in a pack like RLCraft the several hundred Recurrent Complex houses",
                "scattered across the world, every one of which already says somebody works here by",
                "putting a workbench and an oven in the corner.",
                "",
        ...
        @Config.Comment({
                ...
                "mods that add village buildings register them: Recurrent Complex declares RLCraft's",
                "houses as vanilla village pieces, so they are inside a village by this test as surely",
                "as vanilla's own are.",
                "",
