...
# Nine, matching the count and size spread the sibling icons use: two large, the
# rest mid-sized, none of the tiny ones - twice this many read as noise.
SPARKLE_FIELD = [
    (86, 122, 26, 235), (424, 116, 22, 228), (150, 62, 13, 195),
    (58, 252, 15, 200), (456, 250, 14, 198), (46, 372, 12, 180),
    (466, 356, 11, 175), (112, 436, 17, 205), (394, 440, 15, 200),
]
